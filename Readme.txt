...
4.  **Run Unit Tests:**
This project includes JUnit 5 unit tests located in the `src/test/java/com/dot/` directory. Both `AppTest.java` and `VideoManagerTest.java` are executed when `mvn test` is run.
* **`VideoManagerTest.java`**:
 ...
 Viewing Detailed HTML test report:
